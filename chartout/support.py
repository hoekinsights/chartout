...
from .models import ActiveItem, ActiveTexture  # Import ActiveItem and ActiveTexture from models
...
def viz_to_active_item(viz: Any) -> ActiveItem:
    ...
    return ActiveItem(
        ...
        position=None,  # Set position as needed
    )

def viz_to_texture(viz: Any, active_item: ActiveItem) -> Optional[ActiveTexture]:
